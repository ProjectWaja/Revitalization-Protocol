    ...
    <div className="bg-gray-900 rounded-xl border border-gray-800 p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">Privacy-Preserving Solvency Scoring with Attestation Proofs</p>
        </div>
        {confidentialAddress ? (
          ...
          <div className="flex items-center justify-between bg-gray-800/30 rounded-lg p-4">
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <div className={`text-sm font-medium ${RISK_COLORS[RISK_LEVELS[predictedRisk]]}`}>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <div className="bg-gray-800/50 rounded-lg p-3">
                  <div className="text-gray-400 text-xs">On-Chain Score</div>
              ...
              <div className="bg-gray-800/30 rounded-lg p-3">
                <div className="text-xs text-gray-500 mb-1">Attestation Hash (keccak256 of inputs + score + nonce)</div>
                <div className="font-mono text-xs text-orange-400 break-all">{result.attestationHash}</div>
